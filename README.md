...
- **SponsorBlock Integration**: Automatically marks sponsor segments as chapters
...
- SponsorBlock segments (sponsors only for now) are marked as chapters for easy skipping
